...
export default function Edit({ tripData }: { tripData: Trip }) {
const form = useForm<FormData>({
    defaultValues: {
      location: tripData?.destination || "",
      style: tripData?.travelStyle || "",
      from: tripData?.startDate ? new Date(tripData.startDate) : new Date(),
      to: tripData?.endDate ? new Date(tripData.endDate) : new Date(),
